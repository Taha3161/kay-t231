...
if(!["815270276399890485"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
//-------------------------------------------------------------------------------\\
  ...
  message.guild.roles.cache.get("807592814958739517").members.map(r => {
